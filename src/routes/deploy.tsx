...
function Deploy() {
  ...
  return (
    <AppShell>
      <div className="console-page deploy-page">
        <p className="console-eyebrow">New application</p>
        <h1 className="console-title">
          From source to a <em>live deployment.</em>
        </h1>
        ...
        <div className="deploy-source-tabs">
          <button
        ...
        <div className="deploy-form console-panel">
          <div className="deploy-section-heading">
            <span>01</span>
            <div>
              <strong>Choose your source</strong>
              <p>Import a Git repository or upload a local source folder.</p>
            </div>
          </div>
          <div className="space-y-5">
            ...
            <div className="deploy-section-heading">
              ...
              <div>
                ...
                <p>Name the project and reserve its ShelbyHost subdomain.</p>
              </div>
            </div>
            ...
            <div className="deploy-section-heading">
              ...
              <div>
                ...
                <p>Leave these on auto-detect unless your repository needs overrides.</p>
              </div>
            </div>
        ...
        <div className="publish-panel console-panel">
          <div>
            <p className="console-eyebrow">Publication</p>
        ...
        <button
          ...
          className="console-primary deploy-submit disabled:opacity-50"
        >
